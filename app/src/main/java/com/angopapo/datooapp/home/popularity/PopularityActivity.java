...
public class PopularityActivity extends AppCompatActivity {
            ...
            if (rewardedAd != null) {
                OnUserEarnedRewardListener adCallback = new OnUserEarnedRewardListener() {
                    ...
                    public void onUserEarnedReward(@NonNull RewardItem reward) {
                        int creditsAdded = reward.getAmount();
                        mCurrentUser.addCredit(creditsAdded);
    ...
    public void createAndLoadRewardedAd() {
        ...
        RewardedAd.load(this, Constants.getRewardedAdsId(), adRequest, new RewardedAdLoadCallback() {
            @Override
