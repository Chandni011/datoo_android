...
public class PaymentsActivity extends AppCompatActivity implements PaymentProductListSkuAdapter.ItemViewHolder.OnItemSelectedListener, PurchasesUpdatedListener {
    ...
    public void createSlider(){
        ...
        if (mType.equals(TYPE_DATOO_PREMIUM)){
            ...
            unlimitedMessages.setTitle(Application.getInstance().getApplicationContext().getString(R.string.unlimited_messages));
            ...
            findFavorite.setTitle(Application.getInstance().getApplicationContext().getString(R.string.who_added_you));
            ...
            whoLiked.setTitle(Application.getInstance().getApplicationContext().getString(R.string.who_liked_you));
            ...
            messageReadFirst.setTitle(Application.getInstance().getApplicationContext().getString(R.string.get_messsage_read));
            ...
            chatWithNewGirls.setTitle(Application.getInstance().getApplicationContext().getString(R.string.chat_with_girls));
            ...
            undo.setTitle(Application.getInstance().getApplicationContext().getString(R.string.undo_no));
            ...
            chatPopular.setTitle(Application.getInstance().getApplicationContext().getString(R.string.chat_popular));
            ...
            goIncognito.setTitle(Application.getInstance().getApplicationContext().getString(R.string.go_incognito));
            ...
            popular3x.setTitle(Application.getInstance().getApplicationContext().getString(R.string.enyoy_service));
            ...
            riseUp.setTitle(Application.getInstance().getApplicationContext().getString(R.string.first_nearby));
            ...
            getMoreVisits.setTitle(Application.getInstance().getApplicationContext().getString(R.string.more_visits));
            ...
            extraShow.setTitle(Application.getInstance().getApplicationContext().getString(R.string.more_matches));
            ...
            imOnline.setTitle(Application.getInstance().getApplicationContext().getString(R.string.you_re_online));
    ...
    public void onPurchasesUpdated(BillingResult billingResult, @Nullable List<Purchase> purchases) {
        ...
        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK
            ...
            QuickHelp.showNotification(PaymentsActivity.this, Application.getInstance().getString(R.string.purchase_canceled), true);

        } else {
            // Handle any other error codes.

            QuickHelp.showNotification(PaymentsActivity.this, Application.getInstance().getString(R.string.error_try_again_later), true);
        }
    }
    ...
    public void addCreditToAccount(int credits) {
        ...
        mCurrentUser.saveEventually(e -> {
            ...
            if (e == null){
                ...
                QuickHelp.showNotification(PaymentsActivity.this, credits + " " + Application.getInstance().getString(R.string.credit_added_to_yo_a), false);
            }
        });
    }
