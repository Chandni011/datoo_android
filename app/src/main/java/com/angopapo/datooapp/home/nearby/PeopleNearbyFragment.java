...
public class PeopleNearbyFragment extends Fragment {
    ...
    public void getIconRight(User user, Activity activity){
        ...
        if (!user.isLocationTypeNearby() && !user.getLocation().isEmpty()){
            ...
            cityLabel.setText(Application.getInstance().getString(R.string.people_nearby));
        }
        ...
        if (distanceRange != null) {
            distanceRange.setText(String.format(Locale.US, Application.getInstance().getString(R.string.distance_range_filter), user.getPrefDistance()));
        }
        ...
        rangeSeekBarDistance.setOnRangeChangedListener(new OnRangeChangedListener() {
            ...
            public void onRangeChanged(RangeSeekBar view, float leftValue, float rightValue, boolean isFromUser) {
                ...
                distanceRange.setText(String.format(Locale.US, Application.getInstance().getString(R.string.distance_range_filter), (int) leftValue));
