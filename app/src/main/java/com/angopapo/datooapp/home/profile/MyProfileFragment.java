...
public class MyProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (mCurrentUser.getProfilePhotos().size() < 2){
            ...
            mSecondBigText.setText(Application.getInstance().getString(R.string.photos_needed));
            mSecondSmallText.setText(Application.getInstance().getString(R.string.add_photos));
            ...
            mSecondBigText.setText(Application.getInstance().getString(R.string.datoo_premium));
            mSecondSmallText.setText(Application.getInstance().getString(R.string.activate));
            ...
            mSecondBigImage.setImageResource(R.drawable.ic_badge_add_photos);
            mSecondBigText.setText(Application.getInstance().getString(R.string.get_more_visits));
            mSecondSmallText.setText(Application.getInstance().getString(R.string.add_photos));
        ...
        if (mCurrentUser.isVerified()){
            ...
            mProfileBannerText.setText(Application.getInstance().getString(R.string.verified));
            ...
            mProfileBannerText.setText(Application.getInstance().getString(R.string.verify_account));
            mProfileBannerText.setTextColor(Color.WHITE);
                ...
                if (mCurrentUser.getEmail() != null && !mCurrentUser.getEmail().isEmpty()){
                    ...
                    mCurrentUser.saveInBackground(e -> {
                        ...
                        if (e == null){
                            ...
                            QuickHelp.showToast(Objects.requireNonNull(getActivity()), Application.getInstance().getString(R.string.email_verification_sent), false);
                        } else {
                            QuickHelp.hideLoading(getActivity());
                            QuickHelp.showToast(Objects.requireNonNull(getActivity()), Application.getInstance().getString(R.string.error_ocurred), true);
                        }
                    });

                } else {

                    QuickHelp.showToast(Objects.requireNonNull(getActivity()), Application.getInstance().getString(R.string.email_not_exist), true);
                }
            });
