...
public class SendNotifications {
    ...
    public static void SendPush(User fromUser, User toUser, String type, String message){
        ...
        if (type.equals(PUSH_TYPE_MESSAGES) && toUser.getPushNotificationsMassagesEnabled()){
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_message_title));
            params.put(PUSH_NOTIFICATION_MESSAGE, String.format("%s %s %s", Application.getInstance().getString(R.string.you_got), fromUser.getColFullName(), Application.getInstance().getString(R.string.click_to_see)));
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_match_title));
            params.put(PUSH_NOTIFICATION_MESSAGE, String.format("%s %s %s", Application.getInstance().getString(R.string.you_and), fromUser.getColFullName(), Application.getInstance().getString(R.string.match_popup_view_message_two)));
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_like_title));
            params.put(PUSH_NOTIFICATION_MESSAGE, Application.getInstance().getString(R.string.notification_new_like));
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_visitor_title));
            params.put(PUSH_NOTIFICATION_MESSAGE, Application.getInstance().getString(R.string.notification_new_visitor));
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_favorite_title));
            params.put(PUSH_NOTIFICATION_MESSAGE, Application.getInstance().getString(R.string.notification_new_favorite));
            ...
            params.put(PUSH_NOTIFICATION_TITLE, Application.getInstance().getString(R.string.notification_new_live_title));
            params.put(PUSH_TYPE_DATOO_LIVE, Application.getInstance().getString(R.string.notification_new_live));
            params.put(PUSH_NOTIFICATION_TYPE, PUSH_TYPE_MESSAGES);
