...
public class PaymentProductListSkuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder.getItemViewType() == FOOTER_VIEW){
            ...
            SpannableString termsText = new SpannableString(Application.getInstance().getString(R.string.terms_and_conditions));
            ...
            if (productModel.getType().equals(BillingClient.SkuType.INAPP)){
                ...
                switch (productModel.getSku()) {
                    case Config.CREDIT_550:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.credits_550));
                    ...
                    case Config.CREDIT_100:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.credits_100));
                    ...
                    case Config.CREDIT_1250:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.credits_1250));
                    ...
                    case Config.CREDIT_2750:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.credits_2750));
                ...
                switch (productModel.getSku()) {
                    case Config.SUBS_3_MONTHS:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.subs_3_months));
                    ...
                    case Config.SUBS_1_WEEK:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.subs_1_week));
                    ...
                    case Config.SUBS_1_MONTH:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.subs_1_month));
                    ...
                    case Config.SUBS_6_MONTHS:
                        ...
                        holder.ItemName.setText(Application.getInstance().getString(R.string.subs_6_months));
